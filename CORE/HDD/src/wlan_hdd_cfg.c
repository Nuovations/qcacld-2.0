...
/* CFG_VOS_TRACE_ENABLE Parameters */
   ...
   REG_VARIABLE( CFG_AU_THERMAL_TEMP_MIN_LEVEL0_NAME, WLAN_PARAM_Integer,
                 hdd_config_t, auThermalTempMinLevel0,
                 VAR_FLAGS_OPTIONAL | VAR_FLAGS_RANGE_CHECK_ASSUME_DEFAULT,
                 CFG_AU_THERMAL_TEMP_MIN_LEVEL0_DEFAULT,
                 CFG_AU_THERMAL_TEMP_MIN_LEVEL0_MIN,
                 CFG_AU_THERMAL_TEMP_MIN_LEVEL0_MAX ),

   REG_VARIABLE( CFG_AU_THERMAL_TEMP_MAX_LEVEL0_NAME, WLAN_PARAM_Integer,
                 hdd_config_t, auThermalTempMaxLevel0,
                 VAR_FLAGS_OPTIONAL | VAR_FLAGS_RANGE_CHECK_ASSUME_DEFAULT,
                 CFG_AU_THERMAL_TEMP_MAX_LEVEL0_DEFAULT,
                 CFG_AU_THERMAL_TEMP_MAX_LEVEL0_MIN,
                 CFG_AU_THERMAL_TEMP_MAX_LEVEL0_MAX ),

   REG_VARIABLE( CFG_AU_THERMAL_TEMP_MIN_LEVEL1_NAME, WLAN_PARAM_Integer,
                 hdd_config_t, auThermalTempMinLevel1,
                 VAR_FLAGS_OPTIONAL | VAR_FLAGS_RANGE_CHECK_ASSUME_DEFAULT,
                 CFG_AU_THERMAL_TEMP_MIN_LEVEL1_DEFAULT,
                 CFG_AU_THERMAL_TEMP_MIN_LEVEL1_MIN,
                 CFG_AU_THERMAL_TEMP_MIN_LEVEL1_MAX ),

   REG_VARIABLE( CFG_AU_THERMAL_TEMP_MAX_LEVEL1_NAME, WLAN_PARAM_Integer,
                 hdd_config_t, auThermalTempMaxLevel1,
                 VAR_FLAGS_OPTIONAL | VAR_FLAGS_RANGE_CHECK_ASSUME_DEFAULT,
                 CFG_AU_THERMAL_TEMP_MAX_LEVEL1_DEFAULT,
                 CFG_AU_THERMAL_TEMP_MAX_LEVEL1_MIN,
                 CFG_AU_THERMAL_TEMP_MAX_LEVEL1_MAX ),

   REG_VARIABLE( CFG_AU_THERMAL_TEMP_MIN_LEVEL2_NAME, WLAN_PARAM_Integer,
                 hdd_config_t, auThermalTempMinLevel2,
                 VAR_FLAGS_OPTIONAL | VAR_FLAGS_RANGE_CHECK_ASSUME_DEFAULT,
                 CFG_AU_THERMAL_TEMP_MIN_LEVEL2_DEFAULT,
                 CFG_AU_THERMAL_TEMP_MIN_LEVEL2_MIN,
                 CFG_AU_THERMAL_TEMP_MIN_LEVEL2_MAX ),

   REG_VARIABLE( CFG_AU_THERMAL_TEMP_MAX_LEVEL2_NAME, WLAN_PARAM_Integer,
                 hdd_config_t, auThermalTempMaxLevel2,
                 VAR_FLAGS_OPTIONAL | VAR_FLAGS_RANGE_CHECK_ASSUME_DEFAULT,
                 CFG_AU_THERMAL_TEMP_MAX_LEVEL2_DEFAULT,
                 CFG_AU_THERMAL_TEMP_MAX_LEVEL2_MIN,
                 CFG_AU_THERMAL_TEMP_MAX_LEVEL2_MAX ),

   REG_VARIABLE( CFG_AU_THERMAL_TEMP_MIN_LEVEL3_NAME, WLAN_PARAM_Integer,
                 hdd_config_t, auThermalTempMinLevel3,
                 VAR_FLAGS_OPTIONAL | VAR_FLAGS_RANGE_CHECK_ASSUME_DEFAULT,
                 CFG_AU_THERMAL_TEMP_MIN_LEVEL3_DEFAULT,
                 CFG_AU_THERMAL_TEMP_MIN_LEVEL3_MIN,
                 CFG_AU_THERMAL_TEMP_MIN_LEVEL3_MAX ),

   REG_VARIABLE( CFG_AU_THERMAL_TEMP_MAX_LEVEL3_NAME, WLAN_PARAM_Integer,
                 hdd_config_t, auThermalTempMaxLevel3,
                 VAR_FLAGS_OPTIONAL | VAR_FLAGS_RANGE_CHECK_ASSUME_DEFAULT,
                 CFG_AU_THERMAL_TEMP_MAX_LEVEL3_DEFAULT,
                 CFG_AU_THERMAL_TEMP_MAX_LEVEL3_MIN,
                 CFG_AU_THERMAL_TEMP_MAX_LEVEL3_MAX ),
